...
let applyBids pl1Bid pl2Bid gs =
    { gs with
        Actions = []
...
let getDrawPhaseActions gs =
    let nextActionPl1 pl1Bid gs = { gs with Actions = createChoiceActions (fun i -> applyBids pl1Bid i) "Player 2 bid" 1 5 } 
    let nextActionPl2 pl2Bid gs = { gs with Actions = createChoiceActions (fun i -> applyBids i pl2Bid) "Player 1 bid" 1 5 } 
    { gs with 
